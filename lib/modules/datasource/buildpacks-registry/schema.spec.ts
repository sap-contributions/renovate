import {
  BuildpacksRegistryResponseSchema,
} from './schema';

describe('modules/datasource/buildpack-registry/schema', () => {
  it('parses buildpack-registry schema', () => {
    const response = {
      ...
      versions: [
        {
          version: "0.4.0",
          _link: "https://registry.buildpacks.io//api/v1/buildpacks/heroku/python/0.4.0"
        },
        {
          version: "0.3.0",
          _link: "https://registry.buildpacks.io//api/v1/buildpacks/heroku/python/0.3.0"
        },
        {
          version: "0.2.0",
